...
def extract_frame_number(image_path):
    ...
    try:
        ...
        match = re.search(r'frame(\d{4})\.jpg', basename)
        if match:
...
def search_top_k_matches(query_images, query_image_paths, faiss_index, model, 
    ...
    """Search for similar frames with temporal constraints."""
        ...
        for rank, i in enumerate(indices[0]):
            ...
            if frame_diff > frame_diff_threshold and not is_too_close:
                filtered_matches.append(
                    (candidate_image_path, float(distances[0][rank]))
                )
...
if __name__ == "__main__":
    ...
    # Configuration
    image_folder = "/home/luffy/data/VID_20240622_155518_00_007_processed_1600_800"  # Update this path
